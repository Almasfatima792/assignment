        ...
        if( 'yes' === $settings['premium_ihover_icon_fa_switcher'] ) {
            if( 'icon' === $settings['premium_ihover_icon_selection'] ) {
                ...
                $is_new = empty( $settings['premium_ihover_icon_fa'] ) && Icons_Manager::is_migration_allowed();
                    ...
                    $this->add_render_attribute('content_img', 'class', 'premium-ihover-icon-image' );
        
                    $this->add_render_attribute('content_img', 'src', $settings['premium_ihover_icon_image']['url'] );
                    $this->add_render_attribute('content_img', 'alt', Control_Media::get_image_alt( $settings['premium_ihover_icon_image'] ) );
            }
        }
                                    ...
                                    <div class="premium-ihover-content-wrap">
                                        <div class="premium-ihover-title-wrap">
                                            ...
                                            <# }
                                                ...
                                                <img class="premium-ihover-icon-image" src="{{ settings.premium_ihover_icon_image.url }}">
                                            <# } #>
