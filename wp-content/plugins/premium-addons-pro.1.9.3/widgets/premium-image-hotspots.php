	...
	<div <?php echo $this->get_render_attribute_string('container'); ?>>
		...
		?>
	        <div <?php echo $this->get_render_attribute_string( $list_item_key ); ?>>
	            ...
	            ?>
	        	<a class="premium-image-hotspots-tooltips-link" href="<?php echo $link_url; ?>" title="<?php echo $item['premium_image_hotspots_link_text']; ?>" <?php if(!empty($item['premium_image_hotspots_url']['is_external'])) : ?>target="_blank"<?php endif; ?><?php if(!empty($item['premium_image_hotspots_url']['nofollow'])) : ?>rel="nofollow"<?php endif; ?>>
